...
class DistancePublisher(Node):
    def __init__(self):
        ...
        # Trig = 20, Echo = 12
        self.sensor = DistanceSensor(echo=12, trigger=20)
        
        # Create publisher for /distance2
        self.publisher_ = self.create_publisher(Range, '/distance2', 10)
        
        # Create a timer that runs every 1.0 seconds
        self.timer = self.create_timer(1.0, self.timer_callback)
        
        self.get_logger().info('Distance Sensor Node has started (Trig: 20, Echo: 12)')
    ...
    def timer_callback(self):
        ...
        msg.header.frame_id = 'ultrasonic_sensor_link2'
